...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ url('/home') }}" class="logo" style="background-color: #E5725F;">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>A</b>LT</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Prueba</b>Oliver </span>
    </a>

    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top" role="navigation" style="background-color: #E5725F;">
